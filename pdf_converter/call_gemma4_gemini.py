...
def run_python_text_correction_mode(args: argparse.Namespace) -> int:
    ...
    if result.report_paths is not None:
        ...
        print(f"Inspection candidates: {result.report_paths.inspection_candidates_path}")
        print(f"Suppressed candidates: {result.report_paths.suppressed_candidates_path}")
        print(f"Candidate summary: {result.report_paths.candidate_summary_md_path}")
        print(f"Inspection summary: {result.report_paths.inspection_summary_md_path}")
    ...
    print(f"Inspection candidates: {result.inspection_candidate_count}")
    print(f"Suppressed candidates: {result.suppressed_candidate_count}")
    print(f"Suppressed candidate records: {result.suppressed_candidate_record_count}")
